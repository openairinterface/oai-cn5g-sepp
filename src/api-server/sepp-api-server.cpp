...
void SEPPApiServer::init(size_t thr) {
...
void SEPPApiServer::start() {
  Logger::sepp_sbi().info("HTTP1 server started");
  m_httpEndpoint->setHandler(m_router->handler());
  m_httpEndpoint->serve();
}
void SEPPApiServer::shutdown() { m_httpEndpoint->shutdown(); }
