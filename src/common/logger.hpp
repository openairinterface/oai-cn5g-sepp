...
public:
  static void init(const std::string &name, const bool log_stdout,
    ...
    oai::logger::logger_registry::register_logger(name, ASYNC_CMD, log_stdout,
                                                  log_rot_file);
    oai::logger::logger_registry::register_logger(name, ITTI, log_stdout,
                                                  log_rot_file);
    ...
    oai::logger::logger_registry::register_logger(name, SEPP_NBI, log_stdout,
                                                  log_rot_file);
    oai::logger::logger_registry::register_logger(name, SEPP_API_SVR,
